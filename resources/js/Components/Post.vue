...
<template>
    <div id="Post" class="w-full my-4 bg-white rounded-lg shadow-md">
        <div class="flex items-center px-3 py-3">
            <button @click="isUser" class="mr-2">
                <img class="rounded-full ml-1 min-w-[42px] max-h-[42px]" :src="user.image">
            </button>
            <div class="flex items-center justify-between w-full p-2 rounded-full">
                <div>
        ...
        <div id="Likes" class="px-5">
            <div class="flex items-center justify-between py-3 border-b">
                ...
                <div class="text-sm font-semibold text-gray-600">{{ comments.length }} comments</div>
            </div>
        </div>
